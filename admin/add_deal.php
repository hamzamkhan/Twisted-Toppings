        ...
        <div class="container-fluid dashboard-container">
            <div class="row">
                <div class="col-md-2">
                    ...
                    <h4 class="text-center">Add Deal</h4>
                      <form method="post" action="add_deal_function.php" enctype="multipart/form-data">
                        <div class="input-group loginInput loginInput2">
                          <input id="deal_name" type="text" class="form-control input-lg loginInput signUpInput addMenuInput" name="deal_name" placeholder="Deal Name" required="">
                        </div>
                        <div class="input-group loginInput loginInput2">
                          <textarea class="form-control input-lg" id="description" name="description" placeholder="Description"></textarea>  
                        </div>
                        <div class="input-group loginInput loginInput2">
                          <input type="number" class="form-control  input-lg loginInput signUpInput addMenuInput" id="price" min="300"  autocomplete="off" name="price" placeholder="Price" required="">
                        </div>
                        <div class="input-group loginInput loginInput2">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-default loginBtn">Add Deal</button>
                        </div>
