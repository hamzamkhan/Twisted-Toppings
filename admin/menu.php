                            ...
                            <div class="container-fluid">
                                ...
                                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                    <ul class="nav navbar-nav navbar-right">
                                        <li class="link-1"><a href="addmenu.php"><span id="glyphicon" class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add Menu</a></li>
                                        <li class="link-1"><a href="add_drink.php"><span id="glyphicon" class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add Drink</a></li>
                                        <?php
          	...
          	<div class="row">
	              ...
	              <?php
	                ...
	                if($result->num_rows > 0){
	                  echo '<h3>Total Items Listed: ' . $result->num_rows . '</h3>';
	                }
	              ?>
	                <table class="table">
	                  <thead>
	                        ...
	                        while($row = $result->fetch_assoc()){
	                          ?>
	                            <tr>
	                              ...
	                              <td><?php echo $row['price_regular']; ?></td>
	                              <td><?php echo $row['price_large']; ?></td>
	                              <td><?php echo $row['price_jumbo']; ?></td>
	                              <td><a href="delete-menu.php?id=<?php echo $row['id_item']; ?>">Delete</a></td>
	                              <td><a href="edit-menu.php?id=<?php echo $row['id_item']; ?>">Edit</a></td>
	                            </tr>
	                          <?php
	                        }
	                      }
