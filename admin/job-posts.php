                            ...
                            <div class="container-fluid">
                                ...
                                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                    ...
                                    <ul class="nav navbar-nav navbar-right">
                                        <li class="link-1"><a href="create-job-post.php"><span id="glyphicon" class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add Job Post</a></li>
                                        <?php
                        ...
                        while($row1 = $result1->fetch_assoc()){
                          ?>
                            <tr>
                              ...
                              <td><a href="view-this-job-post.php?id=<?php echo $row1['id_jobpost']; ?>">View</a></td>
                              <td><a href="edit-job-post.php?id=<?php echo $row1['id_jobpost']; ?>">Edit</a></td>
                              <td><a href="delete-job-post.php?id=<?php echo $row1['id_jobpost']; ?>">Delete</a></td>
                            </tr>
                            <?php
                                }
                              }
