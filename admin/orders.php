            ...
            <div class="row">
              <div class="col-md-4">
                <div class="list-group">
                  ...
                  <a href="orders.php" class="list-group-item active">Orders</a>
                </div>
              </div>
                <div class="col-md-8">
                <h4>Orders</h4>
                ...
                if($result->num_rows > 0){
                  echo '<h3>Orders Placed : ' . $result->num_rows . '</h3>';
                }
              ?>
                <table class="table">
                  <thead>
                        ...
                        while($row1 = $result1->fetch_assoc()){
                          ?>
                            <tr>
                              ...
                              <td>Rs.<?php echo $row1['total_price']; ?></td>
                            </tr>
                            <?php
                                }
                              }
